...
export function EditProfileDialog({ profile, isOpen, onOpenChange }: EditProfileDialogProps) {
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <DialogFooter>
                            ...
                            <Button type="submit" disabled={updateMutation.isPending || jellyfinUsersQuery.isLoading}>
